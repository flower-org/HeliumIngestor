...
public class HttpStaticFileServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
  final static Logger LOGGER = LoggerFactory.getLogger(HttpStaticFileServerHandler.class);
  ...
  @Nullable
  private static String sanitizeUri(File root, String uri) {
    // Decode the path.
    try {
    ...
    return root.getAbsolutePath() + File.separator + uri;
  }
